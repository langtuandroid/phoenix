...
namespace GercStudio.USK.Scripts
{
...
#endif
    {
        ...
        void Start()
        {
            ...
            var allCars = FindObjectsOfType<NWH.VehiclePhysics2.VehicleController>().ToList();
        ...
        void GetInVehicle()
        {
            ...
            if (matchesCharacterCamera)
            {
                ...
                {
                    case CharacterHelper.CameraType.ThirdPerson:
                        currentCarCamera = targetVehicle.cameraMouseDrag;//!controller.emulateTDModeLikeTP ? targetVehicle.cameraMouseDrag : targetVehicle.cameraFollow;
                        break;
                    case CharacterHelper.CameraType.FirstPerson:
                        currentCarCamera = targetVehicle.cameraInsideVehicle;
                        break;
                    case CharacterHelper.CameraType.TopDown:
                        currentCarCamera = targetVehicle.cameraMouseDrag;//targetVehicle.cameraFollow;
                        break;
                }
