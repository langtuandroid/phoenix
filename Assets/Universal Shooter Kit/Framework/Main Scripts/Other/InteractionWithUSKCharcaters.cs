...
namespace GercStudio.USK.Scripts
{
...
#endif
    {
        ...
        void Awake()
        {
            ...
            vehicleController = GetComponent<NWH.VehiclePhysics2.VehicleController>();
            FindGetOutPosition();
        ...
        {
            var exitPoint = transform.FindObjectsWithTag("EnterExitPoint").FirstOrDefault(); 
            
            if (exitPoint)
            {
                getOutPosition = exitPoint.transform;
            }
            else
            {
                var getOut = new GameObject("EnterExitPoint");
