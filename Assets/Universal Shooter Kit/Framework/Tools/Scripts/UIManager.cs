			...
			switch (type)
			{
				...
				case "avatars":
					...
					if (avatarsMenu.scrollRect)
					{
						...
						currentButton =  
#if USK_ADVANCED_MULTIPLAYER
							multiplayerType == "advanced" ? advancedLobbyManager.AllAvatarsPlaceholders[advancedLobbyManager.gameData.valuesToSave.avatarIndex].Button : 
#endif
				...
				case "maps":
					...
					if (mapsMenu.scrollRect)
					{
						...
						if (
#if USK_ADVANCED_MULTIPLAYER
							multiplayerType == "advanced" && advancedLobbyManager.AllMapsPlaceholders.Count > 0 && advancedLobbyManager.gameData.valuesToSave.selectedMapIndex != -1 || 
#endif
						    multiplayerType != "advanced" && lobbyManager.allMapsPlaceholders.Count > 0)
						{
							currentButton =
								...
								multiplayerType == "advanced"
									? advancedLobbyManager.AllMapsPlaceholders[advancedLobbyManager.gameData.valuesToSave.selectedMapIndex].Button
									:
#endif
