...
//             }
        ...
        void CheckButtons()
        {
            ...
            if (Controller.projectSettings.ButtonsActivityStatuses[3] && (InputHelper.WasKeyboardOrMouseButtonRealised(Controller.projectSettings.keyboardButtonsInUnityInputSystem[3]) || InputHelper.WasGamepadButtonReleased(Controller.projectSettings.gamepadButtonsInUnityInputSystem[3])))
            {
